...
ber1.ratings.create(score:10, user_id:user_1.id)
ber1.ratings.create(score:8, user_id:user_1.id)
ber2.ratings.create(score:4, user_id:user_1.id)
ber2.ratings.create(score:7, user_id:user_1.id)
ber3.ratings.create(score:14, user_id:user_2.id)
ber3.ratings.create(score:18, user_id:user_2.id)
ber4.ratings.create(score:5, user_id:user_2.id)
ber4.ratings.create(score:6, user_id:user_2.id)
